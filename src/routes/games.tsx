...
import { Timer, Brain, Hand, Repeat, Zap, Eye, Wind, Target, Search, ListOrdered, Layers, Palette, MoveHorizontal, Music, Hourglass, ClipboardList, Shuffle } from "lucide-react";
